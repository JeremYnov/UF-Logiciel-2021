...
def routes(api):
     ...
     api.add_resource(InvoiceController, '/api/invoice/<string:id>/update', '/api/invoice/form', '/api/invoices', '/api/invoice/<string:id>', '/api/invoice/<string:id>/delete', '/api/invoice/new')
