...
def routes(api):
     api.add_resource(ProductController, '/api/product/<string:id>/image/<string:filename>', '/api/product/<string:id>/update', '/api/product/new', '/api/product/<string:id>', '/api/products', '/api/product/<string:id>/delete')
